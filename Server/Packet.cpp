...
void Packet::InitCryptoKeySend(int _sendProtocol)
{
	...
	l_focusPointer = MemoryCopy(l_focusPointer, l_dataSize, m_cryptionMainKey);
	l_focusPointer = MemoryCopy(l_focusPointer, l_dataSize, m_cryptionSubKey1);
	l_focusPointer = MemoryCopy(l_focusPointer, l_dataSize, m_cryptionSubKey2);
...
void Packet::PacketDataAdd(unsigned int _protocol, int _dataSize, BYTE* _data, bool _flag)
{
	...
	l_focusPointer = MemoryCopy(l_focusPointer, l_dataSize, _protocol);
	l_focusPointer = MemoryCopy(l_focusPointer, l_dataSize, m_sendCount);
	m_sendCount++;
	...
	l_focusPointer = MemoryCopy(l_focusPointer, l_dataSize, l_dataSize);
